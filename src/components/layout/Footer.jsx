                                ...
                                {Object.entries(SOCIAL_LINKS).map(([platform, url]) => {
                                    ...
                                    return Icon ? (
                                        <a
                                            ...
                                            className=" relative p-4 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 hover:border-primary/50 hover:scale-110 transition-all duration-300 group"
